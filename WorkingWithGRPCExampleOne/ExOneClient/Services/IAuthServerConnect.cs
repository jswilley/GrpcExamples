...
namespace Ex1GrpcClient
{
    ...
    public class AuthServerConnect : IAuthServerConnect
    {
        ...
        public AuthServerConnect(HttpClient httpClient,  IDiscoveryCache discoveryCache, ILogger<AuthServerConnect> logger)
        {
        ...
        public async Task<string> RequestClientCredentialsTokenAsync()
        {
            ...
            DiscoveryDocumentResponse endPointDiscovery = await _discoveryCache.GetAsync();
